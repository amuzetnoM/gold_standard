...
class TaskExecutor:
    ...
    def _handle_research(self, action) -> TaskResult:
        ...
        prompt = f"""You are a senior financial research analyst at Gold Standard Intelligence.
...
Be specific and data-driven. Target 300-500 words."""
        ...
        try:
            ...
            with open(filepath, "w", encoding="utf-8") as f:
                ...
                # Metadata block
                f.write("> **Gold Standard Research Brief**  \n")
                ...
                # Footer
                f.write("\n\n---\n")
                f.write("*Research generated by Gold Standard Intelligence System*\n")
...
4. Key actionable takeaways for positioning"""
            ...
            try:
                ...
                with open(filepath, "w", encoding="utf-8") as f:
                    ...
                    f.write("> **Gold Standard News Scan**  \n")
                    f.write(f"> Generated: {datetime.now().strftime('%Y-%m-%d %H:%M')}  \n")
                    ...
                    f.write("\n\n---\n")
                    f.write("*News scan by Gold Standard Intelligence System*\n")
