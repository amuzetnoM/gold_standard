#!/usr/bin/env python3
"""
Gold Standard Live Analysis Module
...
def generate_3m_analysis(market_data: Dict, ai_analysis: str = "", no_ai: bool = False) -> str:
    ...
    bullish_factors = 0
    if dxy < 103: bullish_factors += 1
    if vix > 18: bullish_factors += 1
    if yield_10y < 4.0: bullish_factors += 1
...
class LiveAnalyzer:
    ...
    def run_full_analysis(self, gold_price: float = 0, silver_price: float = 0, 
                          current_bias: str = "NEUTRAL") -> Dict[str, str]:
