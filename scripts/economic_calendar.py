...
def get_december_2025_events() -> List[EconomicEvent]:
    ...
    return [
        EconomicEvent(
            date="2025-12-02", time="10:00", country="US",
            event="ISM Manufacturing PMI",
            impact=EventImpact.HIGH, category=EventCategory.MANUFACTURING,
            forecast="48.0", previous="46.5",
            gold_impact="Below 50 = Contraction = Bullish for gold",
            notes="Manufacturing sector health check"
        ),
        EconomicEvent(
            date="2025-12-03", time="10:00", country="US",
            event="JOLTS Job Openings",
            impact=EventImpact.MEDIUM, category=EventCategory.EMPLOYMENT,
            forecast="7.5M", previous="7.4M",
            gold_impact="Falling openings = labor cooling = Bullish",
            notes="Labor demand indicator"
        ),
        EconomicEvent(
            date="2025-12-04", time="08:15", country="US",
            event="ADP Employment Change",
            impact=EventImpact.MEDIUM, category=EventCategory.EMPLOYMENT,
            forecast="150K", previous="233K",
            gold_impact="Weak = Bullish | Strong = Bearish",
            notes="NFP preview"
        ),
        EconomicEvent(
            date="2025-12-04", time="10:00", country="US",
            event="ISM Services PMI",
            impact=EventImpact.HIGH, category=EventCategory.MANUFACTURING,
        ...
        EconomicEvent(
            date="2025-12-05", time="08:30", country="US",
            event="Unemployment Rate",
            impact=EventImpact.HIGH, category=EventCategory.EMPLOYMENT,
            forecast="4.2%", previous="4.1%",
            gold_impact="Rising = Bullish | Falling = Bearish",
            notes="Fed dual mandate"
        ),
        EconomicEvent(
            date="2025-12-06", time="08:30", country="US",
            event="Nonfarm Payrolls (NFP)",
            impact=EventImpact.HIGH, category=EventCategory.EMPLOYMENT,
            forecast="200K", previous="12K",
            gold_impact="Weak = Bullish (rate cuts) | Strong = Bearish",
            notes="Most important jobs report"
        ),
        EconomicEvent(
            date="2025-12-11", time="08:30", country="US",
            event="Consumer Price Index (CPI) YoY",
            impact=EventImpact.HIGH, category=EventCategory.INFLATION,
        ...
        EconomicEvent(
            date="2025-12-12", time="08:30", country="US",
            event="Producer Price Index (PPI) YoY",
            impact=EventImpact.MEDIUM, category=EventCategory.INFLATION,
            forecast="2.5%", previous="2.4%",
            gold_impact="Upstream inflation = Bullish",
            notes="Pipeline inflation"
        ),
        EconomicEvent(
            date="2025-12-12", time="13:15", country="EU",
            event="ECB Interest Rate Decision",
            impact=EventImpact.HIGH, category=EventCategory.CENTRAL_BANK,
            forecast="3.15%", previous="3.40%",
            gold_impact="ECB cut = EUR weak = DXY strong = Bearish short-term",
            notes="25bp cut expected"
        ),
        EconomicEvent(
            date="2025-12-17", time="08:30", country="US",
            event="Retail Sales MoM",
            impact=EventImpact.MEDIUM, category=EventCategory.CONSUMER,
            forecast="0.4%", previous="0.4%",
            gold_impact="Weak = Bullish | Strong = Bearish",
            notes="Consumer spending"
        ),
        EconomicEvent(
            date="2025-12-18", time="14:00", country="US",
            event="FOMC Interest Rate Decision",
            impact=EventImpact.HIGH, category=EventCategory.FED_POLICY,
            forecast="4.25-4.50%", previous="4.50-4.75%",
            gold_impact="Cut = Bullish | Hold/Hawkish = Bearish",
            notes="25bp cut priced in ~70%"
        ),
        EconomicEvent(
            date="2025-12-18", time="14:30", country="US",
        ...
        EconomicEvent(
            date="2025-12-19", time="07:00", country="UK",
            event="BOE Interest Rate Decision",
            impact=EventImpact.MEDIUM, category=EventCategory.CENTRAL_BANK,
            forecast="4.75%", previous="4.75%",
            gold_impact="GBP moves affect DXY",
            notes="Hold expected"
        ),
        EconomicEvent(
            date="2025-12-19", time="03:00", country="JP",
            event="BOJ Interest Rate Decision",
            impact=EventImpact.MEDIUM, category=EventCategory.CENTRAL_BANK,
        ...
        EconomicEvent(
            date="2025-12-20", time="08:30", country="US",
        ...
        EconomicEvent(
            date="2025-12-23", time="10:00", country="US",
            event="New Home Sales",
            impact=EventImpact.LOW, category=EventCategory.HOUSING,
            forecast="730K", previous="738K",
            gold_impact="Rate sensitivity indicator",
            notes="Housing demand"
        ),
        EconomicEvent(
            date="2025-12-24", time="08:30", country="US",
            event="Initial Jobless Claims",
            impact=EventImpact.MEDIUM, category=EventCategory.EMPLOYMENT,
...
def get_january_2026_events() -> List[EconomicEvent]:
    ...
    return [
        EconomicEvent(
            date="2026-01-03", time="10:00", country="US",
            event="ISM Manufacturing PMI",
            impact=EventImpact.HIGH, category=EventCategory.MANUFACTURING,
        ...
        EconomicEvent(
            date="2026-01-08", time="14:00", country="US",
            event="FOMC Meeting Minutes (December)",
            impact=EventImpact.MEDIUM, category=EventCategory.FED_POLICY,
            gold_impact="Details on Dec decision and 2026 outlook",
            notes="Watch for rate path guidance"
        ),
        EconomicEvent(
            date="2026-01-10", time="08:30", country="US",
            event="Nonfarm Payrolls (NFP)",
            impact=EventImpact.HIGH, category=EventCategory.EMPLOYMENT,
        ...
        EconomicEvent(
            date="2026-01-15", time="08:30", country="US",
            event="Consumer Price Index (CPI) YoY",
            impact=EventImpact.HIGH, category=EventCategory.INFLATION,
        ...
        EconomicEvent(
            date="2026-01-29", time="14:00", country="US",
            event="FOMC Interest Rate Decision",
            impact=EventImpact.HIGH, category=EventCategory.FED_POLICY,
        ...
        EconomicEvent(
            date="2026-01-31", time="08:30", country="US",
            event="Core PCE Price Index YoY",
            impact=EventImpact.HIGH, category=EventCategory.INFLATION,
